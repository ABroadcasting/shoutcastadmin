		...
		if (!mode)
			{
			  ...
			  var St = dragger.dragStartNode.parentObject.treeNod.label;
			  var La = dragger.lastLanding.dragLanding.label;
			  dragger.lastLanding=null;
			   
			  if((St == "tree1" && La == "tree2") || (St == "tree2" && La == "tree3")|| (St == "tree2" && La == "tree2"))
			  {
