...
function dhtmlXTreeObject(htmlObject, width, height, rootId){
   ...
   this.childCalc=null;
      this.def_img_x="0px";
      this.def_img_y="0px";
      this.def_line_img_x="0px";
      this.def_line_img_y="0px";
   ...
   this.dpcpy=true;
	...
	this._oie_onXLE=[];
   this.imPath="images/";
   this.checkArray=new Array("blank.gif","blank.gif","blank.gif","blank.gif","blank.gif","blank.gif");
   this.radioArray=new Array("blank.gif","blank.gif","blank.gif","blank.gif","blank.gif","blank.gif");

   this.lineArray=new Array("blank.gif","blank.gif","blank.gif","blank.gif","blank.gif","blank.gif");
   this.minusArray=new Array("blank.gif","blank.gif","blank.gif","blank.gif","blank.gif");
   this.plusArray=new Array("blank.gif","blank.gif","blank.gif","blank.gif","blank.gif");
   this.imageArray=new Array("blank.gif","blank.gif","blank.gif");
   this.cutImg= new Array(0,0,0);
   this.cutImage="blank.gif";
   this.parentObject.background="blank.gif";
...
*/
   dhtmlXTreeObject.prototype._moveNodeTo=function(itemObject,targetObject,beforeNode){
	...
	if(beforeNode.parentObject == 0) beforeNode = "";
...
//	targetObject.tr=0;
   ...
   if ((framesMove)||(oldTree.dpcpy)) {//interframe drag flag
      ...
      itemObject=this._recreateBranch(itemObject,targetObject,beforeNode,0);
	  ...
	  itemObject.htmlNode.bgColor = "FFAAAA";
...
*     @topic: 0
*/
   dhtmlXTreeObject.prototype.enabledpcpy=function(mode){
...
dhtmlXTreeObject.prototype._drag=function(sourceHtmlObject,dhtmlObject,targetHtmlObject){
	...
	if (!targetHtmlObject.parentObject){
		...
		var tree = this.htmlNode.htmlNode.childNodes[0].childNodes[0].childNodes[1].childNodes[0];
      this._clearMove();
       ...
       if ((!this.dragMove)||(this.dragMove()))
          {
              if ((!z)||(!z._clearMove)||(!z._dragged)) var col=new Array(sourceHtmlObject.parentObject);
				...
				if(sourceHtmlObject.dragLanding.XMLsource != "xml.php") {
				//trg = window.tree3;
				}

                for (var i=0; i<col.length; i++){
                   var newID=this._moveNodeTo(col[i],tree.parentObject,trg);
